      ...
      <div className="flex flex-col md:flex-row justify-between items-center md:items-start gap-4 h-full">
        ...
        <div className="flex flex-col justify-between items-start gap-8 h-full">
          ...
          <AlertMessage
            ...
            message={`Кнопка полива станет доступна за 2 дня до запланированного полива. Вы сможете полить растение вручную до ${nextWatering ?? '?'}, чтобы отменить автоматический полив.`}
          />
        </div>
      </div>
    </WeatherCard>
